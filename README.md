...
It is necessary to upload the firmware to a compatible ESP32 device. If this readme is not enough, you can find more information here: ["Namazu documentation"](https://namazu.de/). In our realizations of Namazu we used e.g. a NodeMCU ESP32-WROOM32 device.

# Flashing of ESP32

Connect the ESP32 via a micro USB cable with your computer and identify the USB port by e.g. the device manager or PlatformIO.
...
Press build. As indicated by <span style="color:orange"> *1.* </span> in Figure 2 below. Alternatively you can also use the buttons that are normally in the VSC UI located in the top-right corner, here see <span style="color:yellow"> *4.* </span> Figure 2.
...
Then upload the build by pressing the upload button (inicated by <span style="color:red"> *2.* </span> in Figure 2 above) in PlatformIO.
